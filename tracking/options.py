...
opts = OrderedDict() # OrderedDict will sort the element based on the order of time it was put in
opts['use_gpu'] = True

opts['model_path'] = '../models/mdnet_vot-otb_author.pth'
