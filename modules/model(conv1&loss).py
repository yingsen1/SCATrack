            ...
            if run:
                if name == 'conv1':
                    ...
                    # x = module[0](x)
                                                           # 这里为seblock运算
                    # original_x = x # 新分支
                    # out = self.seblocks[0][0](x) # GAP
                    # out = x.view(x.size(0), -1) # flatten
                    # out = self.seblocks[0][1](x) # linear
                    # out = self.seblocks[0][2](x) # RELU
                    # out = self.seblocks[0][3](x) # linear
                    # out = self.seblocks[0][4](x) # Sigmoid
